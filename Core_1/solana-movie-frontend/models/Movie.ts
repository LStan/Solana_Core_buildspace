...
export class Movie {
    ...
    borchInstructionSchema = borsh.struct([
        borsh.u8('variant'),
        borsh.str('title'),
        borsh.u8('rating'),
    ...
    setialize(): Buffer {
        ...
        this.borchInstructionSchema.encode({...this, variant: 0}, buffer)
        return buffer.slice(0, this.borchInstructionSchema.getSpan(buffer))
    }
}